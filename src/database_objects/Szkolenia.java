...
public class Szkolenia extends Osiagniecia implements TableObj {
    private Integer czas_szkolenia;


    @Override
    public String getCzas_szkolenia() {
        return Integer.toString(czas_szkolenia);
    }

    public void setCzas_szkolenia(int czas_szkolenia) {
        this.czas_szkolenia = czas_szkolenia;
    }
    ...
    public void setFromResultSet(ResultSet rs) {
        ...
        try {
            czas_szkolenia = rs.getInt("czas_szkolenia");
        } catch(Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void setToPreparedStatement(PreparedStatement stmt) {
        try {
            ...
            if (czas_szkolenia != null)
                stmt.setInt(9, czas_szkolenia);
            else
    ...
    public void insert() {
        String sql = "INSERT INTO OSIAGNIECIA " +
                ...
                "MIEJSCE_UZYSKANIA, CZAS_SZKOLENIA, OPIS) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
